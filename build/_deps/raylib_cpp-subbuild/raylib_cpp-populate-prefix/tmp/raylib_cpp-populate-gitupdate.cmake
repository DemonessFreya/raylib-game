...
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git show-ref "v5.5.0"
  WORKING_DIRECTORY "C:/Users/Freyja/Documents/GitHub/raylib-game/build/_deps/raylib_cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Freyja/Documents/GitHub/raylib-game/build/_deps/raylib_cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Freyja/Documents/GitHub/raylib-game/build/_deps/raylib_cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
